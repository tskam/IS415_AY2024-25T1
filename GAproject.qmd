...
Students are required to choose one of the [ASEAN](https://asean.org/member-states/) country as the study area and select at least one following theme to develop the GeoSpaital Analytics Project:
...
-   Dimension = around 7200 by 9900 pixels
-   File format = jpeg
